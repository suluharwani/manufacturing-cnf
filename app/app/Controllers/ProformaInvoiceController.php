...
// die();
    ...
    public function listdataPi($id)
    {
        ...
        $select_columns = 'finishing.name as finishing , proforma_invoice.status as status,proforma_invoice.invoice_number as pi, proforma_invoice_details.*, proforma_invoice_details.id as det_id,product.nama as nama, product.kode as kode,product.id as id_product';
        ...
        $joins = [
            ...
            ['finishing', 'finishing.id = proforma_invoice_details.finishing_id', 'left'],
        ];
...
public function printInvoiceNeed($invoice_id)
    ...
    ->join('billofmaterialfinishing bom', 'pid.id_product = bom.id_product AND bom.id_modul = pid.finishing_id', 'left')
    ->join('materials m', 'bom.id_material = m.id', 'left')
