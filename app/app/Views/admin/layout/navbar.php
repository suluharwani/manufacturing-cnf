        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="<?= base_url('logistic') ?>" class="dropdown-item">Logistic</a>
                    <a href="<?= base_url('material_requisition_progress') ?>" class="dropdown-item">Progress Material Requisition</a>
                    <a href="<?= base_url('material_requisition_progress_completed') ?>" class="dropdown-item">All MR List</a>
                    ...
                    <a href="<?= base_url('stock-opname') ?>" class="dropdown-item">Stock Opname</a>
                </div>
            </div>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="<?= base_url('report/document') ?>" class="dropdown-item">Document</a>
