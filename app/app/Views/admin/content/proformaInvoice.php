...
<div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Proforma Invoice</h6>
                        <button class= "btn btn-primary tambahProformaInvoice">Tambah</button>
                    </div>
...
<script type="text/javascript" src="<?= base_url('assets') ?>/js/proformainvoice.js"></script>
