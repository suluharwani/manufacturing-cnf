...
<body>
    ...
    <tr>
        ...
        <table >
            <tr>
                <td width="70%">PI NUMBER: <?=$mreq['pi']?></td>
                <td>DEPARTMENT: <?=$mreq['dep']?></td>
                
            </tr>
            <tr>
                <td>WO NUMBER: <?=$mreq['wo']?></td>
                <td>REQUESTOR: <?=$mreq['requestor']?></td>
            </tr>
            <tr>
                <td>REQUISITION NUMBER: <?=$mreq['code']?></td>
                <td>DATE: <?=formatDateJam($mreq['created_at'])?></td>
            </tr>
        </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td align="center"><?=formatCurrency($item['jumlah'])?></td>
                    <td align="center"><?=$item['satuan_kode']?></td>
