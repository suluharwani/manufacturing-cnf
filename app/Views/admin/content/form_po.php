      ...
      <div class="container mt-5">
        ...
        <form>
          <div class="row mb-3">
            ...
            <div class="col-md-9">
              <input type="text" class="form-control" value="<?= $po[0]['code'] ?>" id="invoice" placeholder="Invoice"
                disabled>
            </div>
          </div>
          <!--     <div class="row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" class="form-control" value="" id="invoice" placeholder="Invoice" disabled>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-9">
              <textarea class="form-control" rows="4" id="supplier_address"
                disabled><?= $po[0]['supplier_address'] ?></textarea>
            </div>
          </div>
          <div class="row mb-3">
