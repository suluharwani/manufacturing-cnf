...
<div class="container-fluid pt-4 px-4">
  ...
  <form>
    <div class="row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" class="form-control" value="<?=$pi[0]['invoice_number']?>" id="invoice" placeholder="Invoice" disabled> 
      </div>
    </div>
<!--     <div class="row mb-3">
      ...
      <div class="col-md-9">
                <input type="text" class="form-control" value="<?=$pi[0]['customer_name']?>" id="customer" placeholder="customer" disabled>
...
<script type="text/javascript" src="<?= base_url('assets') ?>/js/form_pi.js"></script>
