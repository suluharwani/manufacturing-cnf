...
class ProformaInvoice extends Model
{
    ...
    protected $allowedFields    = ['status_delivery','id','port_loading','port_discharge','end_prod','charge','deposit','invoice_number','invoice_date','customer_id','customer_address','id_currency','etd','eta','payment_terms','remarks','status','vessel','cus_po','loading_date','updated_at','deleted_at','created_at'];
