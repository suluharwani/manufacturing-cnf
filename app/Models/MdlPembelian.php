...
class MdlPembelian extends Model
{
    ...
    protected $allowedFields    = ['id','remarks','jenis_doc','id_po', 'id_supplier','id_currency','invoice','tanggal_nota','tanggal_jatuh_tempo','document','status_pembayaran','pajak','posting', 'created_at', 'updated_at', 'deleted_at'];
