...
$routes->post('/deleteBom/(:any)', 'ProductController::deleteBom/$1',['filter' => 'accessControl:2']);
$routes->post('/addbom', 'ProductController::addbom',['filter' => 'accessControl:2']);
...
$routes->get('/dashboard/getProductionReportPI/(:any)', 'DashboardController::getProductionReportPI/$1',['filter' => 'accessControl:2']);
$routes->get('/dashboard/getWHreportPI/(:any)', 'DashboardController::getWHreportPI/$1',['filter' => 'accessControl:2']);
$routes->get('/dashboard/getPIReport', 'DashboardController::getPIReport',['filter' => 'accessControl:2']);
...
$routes->group('pembelian', ['namespace' => 'App\Controllers'], function ($routes) {
    ...
    $routes->get('getDocumentList', 'ControllerPembelian::getDocumentList',['filter' => 'accessControl:2']); 
...
$routes->group('report', function ($routes) {
    ...
    $routes->get('materialhistory/(:any)', 'ReportController::materialhistory/$1',['filter' => 'accessControl:2']); 
