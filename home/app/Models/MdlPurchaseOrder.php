...
class MdlPurchaseOrder extends Model
{
    ...
    protected $allowedFields    = ['id','top','code','date','supplier_id','vat','arrival_target','remarks','status','updated_at','deleted_at','created_at'];
