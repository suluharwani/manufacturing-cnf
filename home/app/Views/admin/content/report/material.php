...
<style>
    ...
    table {
        ...
        /* Untuk menggabungkan border agar lebih rapi */
        width: 100%;
    }
    ...
    td {
        ...
        /* Border hitam dengan ketebalan 1px */
        padding: 8px;
    ...
    tr:nth-child(even) {
        ...
        /* Memberikan warna latar belakang yang lebih terang pada baris genap */
    }
    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="generateReportBtnMaterial"
                ...
                <div class="modal fade" id="laporanScrapModal" tabindex="-1" aria-labelledby="laporanModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="generateReportBtnScrap"
                                    data-bs-dismiss="modal">View</button>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            </div>
                        </div>
