<div class="container-fluid pt-4 px-4">
    <div class="bg-light rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h4 class="mb-0">BC Export Data</h4>
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $item['kode_jenis_ekspor'] ?></td>
                        <td class="text-end"><?= number_format($item['nilai_barang'], 2) ?></td>
                        <td class="text-center">
                            <a href="<?= base_url('bc-export/detail/' . $item['id']) ?>" class="btn btn-sm btn-info">
                                <i class="fa fa-eye"></i>
                            </a>
                        </td>
                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importModalLabel">Import BC Export Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <?= form_open_multipart('bc-export/process', ['id' => 'importForm']) ?>
